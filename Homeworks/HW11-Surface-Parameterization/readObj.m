...
%
% OUTPUT: v - mesh vertices网格顶点
%       : vt - texture coordinates纹理坐标
%       : vn - normal coordinates法向坐标
%       : f - face definition assuming faces are made of of 3 vertices 面定义假设面由3个顶点组成
%
